...
class LoginController extends Controller
{
    ...
    public function register(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'telp_pelanggan' => 'nullable|string|max:20|unique:pelanggan,telp_pelanggan|unique:pelanggan,telp',
            'alamat_pelanggan' => 'required|string|max:255',
            'nama_perusahaan' => 'nullable|string|max:255',
            'nik' => 'nullable|string|max:20',
            'username' => 'required|string|max:255|unique:pelanggan,username|unique:pelanggan,username',
            'email' => 'required|string|email|max:255|unique:pelanggan,email|unique:pelanggan,email',
