                            ...
                            <tr>
                                @forelse ($pesanan as $item)
                                    ...
                                    <td>
                                        ...
                                        @elseif ($item->status == 0 && $item->progres == 1)
                                            <span class="badge bg-info">Ticket Created</span>
                                        @elseif ($item->status == 0 && $item->progres == 2)
                                            <span class="badge bg-warning">Ticket Recieved</span>
                                        @elseif ($item->status == 0 && $item->progres == 3)
                                            <span class="badge bg-secondary">Started</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{route('ticket.detail', $item)}}" class="btn btn-info">
