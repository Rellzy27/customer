            ...
            <div class="card-body">
                <form id="profile-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label>Alamat</label>
                            <input type="text" class="form-control" name="alamat_pelanggan" value="{{ $user->alamat_pelanggan ?? '-' }}"
                                readonly>
                        </div>
                        <div class="col-md-4 form-group">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control" name="telp" value="{{ $user->telp_pelanggan ?? '-' }}" readonly>
                    </div>
                </div>
            </div>
        </div>
