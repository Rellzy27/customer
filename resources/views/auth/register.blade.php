                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-4 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="alamat_pelanggan" type="text" class="form-control"
                                    ...
                                    <div class="form-group mb-4 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="telp_pelanggan" type="text" class="form-control"
                                                name="telp_pelanggan" value="{{ old('telp_pelanggan') }}"
