            ...
            <div class="container">
                <div class="row align-items-center ">
                    <div class="col-12 col-lg-7 order-1 order-lg-1 text-center d-flex align-items-center justify-content-center">
                        <img class="img-fluid w-75" src="{{ asset('volt/assets/img/illustrations/403.svg')}}" alt="403 Forbidden">
                    </div>
                    <div class="col-12 col-lg-5 order-2 order-lg-2 text-center text-lg-left">
                        <h1 class="mt-5">You don't have access to this resource</h1>
                        <p class="lead my-4">Please contact the administrator if you think this is a mistake.</p>
